...
- Slack App created with User OAuth Token (xoxp-) and full scopes: channels:history, channels:read, groups:history, groups:read, im:history, im:read, im:write, mpim:history, mpim:read, mpim:write, users:read, chat:write, search:read
