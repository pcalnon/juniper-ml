# juniper-cascor Address failing tests
...
The juniper-cascor application is curently failing 35 tests
...
ensure entire juniper-cascor test suite passes and complete successfully
