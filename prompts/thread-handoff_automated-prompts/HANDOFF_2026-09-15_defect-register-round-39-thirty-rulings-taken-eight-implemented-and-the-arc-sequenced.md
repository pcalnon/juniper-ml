...
| `APD-DATA-030` "error bodies carry no retryability signal" | **Too broad** | `Retry-After` IS sent on the auth-throttle 429, with two tests asserting it. Corrected in `notes/JUNIPER_2026-08-14_JUNIPER-ECOSYSTEM_DEFECT-REGISTER.md`. |
