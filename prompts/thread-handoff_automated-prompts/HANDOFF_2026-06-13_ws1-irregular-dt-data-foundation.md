...
- **[OQ-4] (model pick — RCC vs ESN vs NEAT/LMU) is still OPEN and under active analysis** (juniper-ml#377 + newer P4 delay-line evaluation docs #399/#400/#402) → all #179 §C model-side work is blocked on it. (OQ-4 is its own thread — see `HANDOFF_2026-06-07_recurrent-structure-add-on.md`.)
