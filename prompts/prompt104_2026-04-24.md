...
Create a detailed plan to perform a rigorous and comprehensive code review of the following Juniper Project applications:
...
The code review should focus specifically on the following aspect of the listed Juniper Project applications:
...
Develop a detailed plan to perform a full and comprehensive code review and audit of all specified aspects of the Juniper Project's specified applications.

### Directives

1. Create todo lists, when helpful, to perform the tasks defined in this prompt.
2. Using multiple, appropriately specialized sub-agents analyze all specified aspects of the current, specified applications from the Juniper Project.
3. The highest priority tasks and the focus of this prompt should be the development of the code review and audit plan
4. The plan should specifically require the code review and audit described above.
5. The plan should include requirements to fully document all specified aspects of the Juniper Project's specified applications.
6. The plan should include requirements to identify all instances of applicable problems and issues as describe in the Problem Description section above.
7. The plan should include issue identification requirements should include, but not limited to, the following:
    - Remediations
