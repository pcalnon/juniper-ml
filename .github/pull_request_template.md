...
<!--
  List JR-* IDs touched by this PR. Verbs:
    Closes JR-*           — this PR fully satisfies the requirement (will be marked `shipped` at next refresh).
...
<!-- Bulleted checklist of how this was / will be verified. -->
