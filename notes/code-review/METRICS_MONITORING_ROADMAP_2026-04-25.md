...
| R2.1   | seed-06 shared lib           | design pending     |             |                                               |          | [METRICS_MONITORING_R2.1_SHARED_OBSERVABILITY_DESIGN_2026-04-28.md](METRICS_MONITORING_R2.1_SHARED_OBSERVABILITY_DESIGN_2026-04-28.md). |
|        |                              |                    |             |                                               |          | 5-PR sequence ending with `juniper-observability==0.1.0` on PyPI.                                                                       |
