...
| R2.1   | seed-06 shared lib           | in progress        | Paul Calnon | juniper-ml#155 (R2.1.1 merged) | —        | 5-PR sequence per [design](METRICS_MONITORING_R2.1_SHARED_OBSERVABILITY_DESIGN_2026-04-28.md). R2.1.1 alpha source merged 2026-04-28 as `f0fb496`. **Publish gated on `juniper-observability-v0.1.0a0` tag push** to fire `publish-observability.yml` → TestPyPI → PyPI. R2.1.2 (juniper-data migrate) gated on alpha being installable.        |
