...
| V17 | juniper-data            | lockfile-update.yml | update                                              | secret missing (CROSS_REPO_DISPATCH_TOKEN)                         | P2       | G-CONFIG   | **fixed (verified)** | `CROSS_REPO_DISPATCH_TOKEN` provisioned and validated end-to-end 2026-05-02. See notes/V17_V18_CROSS_REPO_DISPATCH_TOKEN_SETUP_2026-05-02.md for the walkthrough. |
