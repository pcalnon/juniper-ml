...
**Relationship to concurrent roadmaps.** Heavy concurrent-session activity is in flight. Two sibling roadmaps were produced the same day at a *different altitude* and are **not yet on this branch** (named here, not linked, to avoid a dangling reference): `JUNIPER_RECURRENCE_STATE_ASSESSMENT_AND_ROADMAP_2026-06-17.md` (recurrence model/app-specific — deeper WS-4/WS-4b recovery + the model-core 0.2.0 crossval chokepoint) and `JUNIPER_CANOPY_REGRESSION_REMEDIATION_ROADMAP_2026-06-17.md` (the canopy UI-regression track, which this document keeps out of scope). **This document is the platform / template-cluster view** spanning all three anchor efforts; where they overlap (WS-4b recovery, the crossval layer) the findings agree. Cross-link the three once they all land on `main`.
...
- `JUNIPER_PACKAGE_PLACEMENT_AND_RELOCATION_PLAN_2026-06-09.md` — §6/§7 read as pending; §4 says cascor-model unpublished (it is on PyPI 0.1.0).
- `BUILD_PROVENANCE_DESIGN_2026-06-14.md` — header still "pre-implementation"; Part 4 (runtime-only `ARG`) contradicts Part 5.2 ("builder top + runtime re-declare") — implementers correctly followed Part 4.
- `JUNIPER_MODEL_MIDDLEWARE_REFACTOR_DESIGN_AND_PLAN_2026-05-31.md` — Status Tracker stale (WS-1–WS-4 shipped); §8.3 calls the conformance kit a "pytest plugin" but it shipped as an importable subclass-base + `[conformance]` extra.
...
[#431](JUNIPER_MODEL_CORE_CROSSVAL_LAYER_DESIGN_2026-06-16.md) is ratified but unbuilt. When/how to build:
...
- Anchors: [`JUNIPER_PACKAGE_PLACEMENT_AND_RELOCATION_PLAN_2026-06-09.md`](JUNIPER_PACKAGE_PLACEMENT_AND_RELOCATION_PLAN_2026-06-09.md), [`BUILD_PROVENANCE_DESIGN_2026-06-14.md`](BUILD_PROVENANCE_DESIGN_2026-06-14.md), [`JUNIPER_MODEL_MIDDLEWARE_REFACTOR_DESIGN_AND_PLAN_2026-05-31.md`](JUNIPER_MODEL_MIDDLEWARE_REFACTOR_DESIGN_AND_PLAN_2026-05-31.md).
- Cluster: [`JUNIPER_CODE_ORGANIZATION_STRATEGY_2026-06-05.md`](JUNIPER_CODE_ORGANIZATION_STRATEGY_2026-06-05.md), [`JUNIPER_CASCOR_CORE_PYPI_MIGRATION_PLAN_2026-06-03.md`](JUNIPER_CASCOR_CORE_PYPI_MIGRATION_PLAN_2026-06-03.md), [`JUNIPER_MODEL_CORE_INTERFACE_DESIGN_2026-06-14.md`](JUNIPER_MODEL_CORE_INTERFACE_DESIGN_2026-06-14.md), [`JUNIPER_MODEL_CORE_CROSSVAL_LAYER_DESIGN_2026-06-16.md`](JUNIPER_MODEL_CORE_CROSSVAL_LAYER_DESIGN_2026-06-16.md), [`JUNIPER_RECURRENCE_WS4_MODEL_BUILD_PLAN_2026-06-15.md`](JUNIPER_RECURRENCE_WS4_MODEL_BUILD_PLAN_2026-06-15.md), [`JUNIPER_RECURRENCE_WS4B_APP_BUILD_PLAN_2026-06-15.md`](JUNIPER_RECURRENCE_WS4B_APP_BUILD_PLAN_2026-06-15.md), [`JUNIPER_RECURRENCE_MODEL_DETAILED_DESIGN_2026-06-14.md`](JUNIPER_RECURRENCE_MODEL_DETAILED_DESIGN_2026-06-14.md).
