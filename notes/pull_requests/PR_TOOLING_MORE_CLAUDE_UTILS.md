...
- `notes/juniper_OTHER_DEPENDENCIES.md` — Table alignment formatting
...
- `notes/CONDA_DEPENDENCY_FILE_HEADER.yaml` — Renamed from `.md`
...
- `notes/juniper_OTHER_DEPENDENCIES.md` — Table alignment
