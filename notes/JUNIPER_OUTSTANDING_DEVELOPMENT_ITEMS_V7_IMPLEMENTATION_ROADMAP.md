...
Rolled-up totals after this status pass (with CFG-06 shipped 2026-05-23 and CFG-01 / CFG-02 shipped 2026-05-23 / 2026-05-24 folded in):

| Bucket | v7.0.1 | v7.0.2 status pass | Δ |
|---|---|---|---|
| §20 (Configuration/Deps) — open | 13 | 2 confirmed TODO + 2 ambiguous | −9 (6 silently shipped + 3 explicitly shipped via CFG-06 / CFG-01 / CFG-02) |
| §21 (API/Protocol) — open | 10 | 2 confirmed TODO + 4 ambiguous | −4 silently shipped (incl. API-09 + API-01 + API-02 + API-08) |
| Newly catalogued shipped | n/a | 10 items (CFG-12, CFG-13, CFG-14, CFG-16, API-01, API-02, API-08, **CFG-06**, **CFG-01**, **CFG-02**) | +10 |
