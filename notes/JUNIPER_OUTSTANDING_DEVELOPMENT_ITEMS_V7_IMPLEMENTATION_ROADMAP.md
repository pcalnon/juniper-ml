...
|---------------|----------|----------------------------------------------------------------------------------------------|----------------|
| GAP-WS-16     | **P0**   | `/api/metrics/history` polling bandwidth bomb (~3 MB/s per dashboard tab)                    | 🟡 In Review — juniper-cascor [#152](https://github.com/pcalnon/juniper-cascor/pull/152) + juniper-canopy [#195](https://github.com/pcalnon/juniper-canopy/pull/195) |
...
| Phase | Items                                  | Scope  | Description                                      | Status                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|-------|----------------------------------------|--------|--------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 6A    | GAP-WS-16, GAP-WS-14, GAP-WS-15        | 3×L    | Critical: bandwidth reduction, extendTraces, rAF | 🟡 In Review — GAP-WS-15 ✅ (juniper-canopy PR [#186](https://github.com/pcalnon/juniper-canopy/pull/186)), GAP-WS-14 ✅ (juniper-canopy PR [#187](https://github.com/pcalnon/juniper-canopy/pull/187)), GAP-WS-16 🟡 (juniper-cascor PR [#152](https://github.com/pcalnon/juniper-cascor/pull/152) + juniper-canopy PR [#195](https://github.com/pcalnon/juniper-canopy/pull/195) — initial_metrics burst + subscribe_metrics + REST switchover gate + `/v1/metrics/transport` bandwidth instrumentation). |
...
**Track 6 progress (2026-04-28)**: Phases 6B and 6C complete; 6A 3/3 (GAP-WS-16 in review — cascor #152 + canopy #195). Next on the critical path: 6D (dashboard enhancement backlog, 22 items, S-M scope, all in juniper-canopy) or remaining 6F GAP-WS-* items.
