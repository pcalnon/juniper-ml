...
**Status updated 2026-04-28** after a code-state audit against juniper-canopy main, refined during the Phase 1 implementation pass when CAN-002 and CAN-007 turned up as already-shipped. Of 22 items: **10 already implemented**, **4 blocked on missing cascor API surface**, **8 genuinely open**. The audit follows the same recurring pattern observed in CAN-CRIT-001 / KL-1 / CI-01/02 / PERF-CC-03 — V7 roadmap entries described work that was actually shipped during earlier review iterations.
...
| CAN-013  | Meta Param Tuning | Candidate node integration mode                                           | P3       | 🔴 Open (M) — needs new `integration_mode: Literal["replace", "ensemble", "additive"]` in TrainingParams + sidebar radio                                                |
...
| **Phase 2 — medium (~6h)** | CAN-005, CAN-013, CAN-016a | Power-user / workflow improvements after Phase 1 stabilizes. CAN-013 requires a small `TrainingParams` extension (cross-repo). |
...
| 6D    | CAN-000..CAN-021                       | 22×S-M | Dashboard enhancement backlog                    | 🟡 Partial — code-state audit on 2026-04-28 found 10 items already shipped (CAN-001/002/003/004/006/007/008/009/012/017), 4 blocked on missing cascor APIs (CAN-010 optimizer, CAN-011 activation, CAN-014/015 snapshot params), 8 genuinely open. See §[7.2 Canopy Enhancement Backlog](#72-canopy-enhancement-backlog-can-000-through-can-021) for the per-item table and the recommended Phase 1/2/3 PR ordering.                                                                                                                                                                            |
