...
| 6E    | CAS-002..009 + 6 deferred CAN items     | 14×M-XL | CasCor algorithm enhancements + cross-repo CAN-* | 🔴 Outstanding. Original 6E items: CAS-002..009 (cascor algorithm work). **Bundled into 6E (2026-04-29)**: CAN-010 (optimizer surface), CAN-011 (activation surface), CAN-013 (integration mode), CAN-014 (snapshot tuning capture), CAN-015 (snapshot replay), CAN-021 (parallel-network ensemble view). All six need cascor-side groundwork before canopy can ship a meaningful UI. |
...
**Track 6 progress (2026-04-29 — Phase 3 close)**: Phases 6A, 6B, 6C, 6D complete (4/6). 6F drained (only conditional Phase E..H backpressure pump tasks left). 6E remains — now bundled with **6 cross-repo CAN-* items** (CAN-010 / 011 / 013 / 014 / 015 / 021) on top of the original CAS-002..009. 6E unblocks the entire remaining backlog. Adjacent **Network Evolution** ([juniper-canopy #203](https://github.com/pcalnon/juniper-canopy/pull/203)) shipped a temporal cascade-growth timeline that covers part of CAN-021's "see multiple network states" intent without waiting for 6E.
