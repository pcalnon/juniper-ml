...
| 6F    | Phase E..H, remaining GAP-WS           | 8×M-L  | WebSocket migration remaining phases             | 🔴 Outstanding                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |

**Track 6 progress (2026-04-28)**: Phases 6A, 6B, and 6C complete (3/6). Phase 6D in flight (Phase 1/2 shipped via #190/#191/#192/#193, 4 Phase-3 items + 5 cross-repo blocked items remain). Phase 6E and 6F still outstanding. Next on the critical path: 6D Phase 3 (canopy-only, S-M scope) or 6F GAP-WS-* items (mostly canopy with a few cross-repo).
