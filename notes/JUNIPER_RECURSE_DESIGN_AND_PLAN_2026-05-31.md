...
> **Live design state (2026-06-03):** WS-0 is **not ratified** — the model pick was reopened as **[OQ-4]** (RCC's no-count/no-group "star-free" representational ceiling) and is under active literature review; a model-pick redesign is likely. Canonical status lives in the refactor document's [Status Tracker](JUNIPER_MODEL_MIDDLEWARE_REFACTOR_DESIGN_AND_PLAN_2026-05-31.md#status-tracker) and [Open-Questions table](JUNIPER_MODEL_MIDDLEWARE_REFACTOR_DESIGN_AND_PLAN_2026-05-31.md#part-5--open-questions--areas-of-uncertainty).
