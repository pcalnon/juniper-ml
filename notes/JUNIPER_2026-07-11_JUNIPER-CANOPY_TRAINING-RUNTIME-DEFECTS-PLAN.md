...
| C6               | planned  | —                        | 2026-07-16 | E-1 verdict: per-epoch emission ALREADY EXISTS — scope collapses to gap review (25-epoch stride; no metrics during candidate phases) or closure                                                      |
...
| N3               | planned  | —                        | 2026-07-16 | modal per Q3/Q4; may split N3b; owns demo-FSM start-from-COMPLETED gap (canopy#449); E-2 pins the active-run path: cascor 409s immediately, staging survives → stop→await→start(staged)              |
...
| N5               | planned  | —                        | 2026-07-16 | deps C2a/C2b/N2 all merged — unblocked for wave 3                                                                                                                                                    |
| N6               | planned  | —                        | 2026-07-16 | per-phase counter semantics live-confirmed during E-1/E-2 (epoch resets per phase; metrics_total freezes in candidate phases)                                                                        |
