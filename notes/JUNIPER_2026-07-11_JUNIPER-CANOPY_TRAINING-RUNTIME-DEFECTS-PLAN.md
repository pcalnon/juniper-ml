...
| N3               | pr-open            | juniper-canopy#459       | 2026-07-20 | CI all green; /api/train/restart route (stop→await→start(staged), E-2 pin); Q3/Q4 modal; demo-FSM terminal auto-reset (BEHAVIOR CHANGE for owner review); start_fresh via client _post (CL2-family seam); granular MODIFY split to N3b                      |
| N3b              | planned            | —                        | 2026-07-20 | granular in-place MODIFY inside the restart modal (split from N3: intersects N5's apply contract; sequence after N5 merges)                                                                                                                                 |
...
| N5               | pr-open            | juniper-canopy#460       | 2026-07-20 | CascorPatchBounds mirror + clamp (found real divergences: canopy MAX_LEARNING_RATE 1.0 vs cascor le=10.0, pool 500 vs 256, patience 500 vs 100000 — drift-pin test added); verbatim rejection toasts; C2a partition surfaced REST+WS; liveness-gated WS leg |
