...
| **v3-ship — Regenerate + PR** | ☐ in_progress | 2026-05-14 | — | (this commit) | v3 corpus: 2,120 candidates → 1,773 entries. -28 vs v2 (28 cross-repo/cross-round dedups), but **355 briefs repaired** and **32 junk entries dropped** — quality delta dominates count delta. Citation precision: 97.3% EXACT on the cleaner corpus. |
