...
| **v4-ship — Regenerate + PR** | ☐ in_progress | 2026-05-15 | — | (this commit) | v4 corpus: 2,149 candidates → **1,803 entries**. +30 vs v3 (29 from v4-2, +1 dedup variance). **118 briefs explicitly repaired by v4-1.** Citation precision: **97.7% EXACT** (up from 97.3% in v3). |
