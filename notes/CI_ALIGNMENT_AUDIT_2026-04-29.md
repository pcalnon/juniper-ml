...
| V17     | data lockfile-update.yml                          | ~~Missing `CROSS_REPO_DISPATCH_TOKEN` secret — never configured~~ → **secret provisioned 2026-05-02**, awaiting Dependabot-driven E2E verification |
| V18     | canopy lockfile-update.yml                        | Same — secret provisioned 2026-05-02                                                                               |
...
| G-CONFIG (user-side secret)                           | V17, V18                   | **fixed pending verification** — `CROSS_REPO_DISPATCH_TOKEN` provisioned 2026-05-02; E2E confirmation lands on next Dependabot run |
...
| **juniper-data**          | ✅        | ✅                   | — (V13 + V27 resolved upstream); V17 secret provisioned 2026-05-02 (E2E verification on next Dependabot run)                                    |
| juniper-data-client       | ✅        | ✅                   | —                                                                                                                                               |
