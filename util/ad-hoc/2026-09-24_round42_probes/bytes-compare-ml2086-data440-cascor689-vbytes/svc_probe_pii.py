...
p.add_argument("--send-pii", action="store_true")
...
if args.service == "sc":
    ...
    settings = Settings(storage_path=tmp, api_keys=[SECRET, SECRET2], sentry_dsn=DSN if args.sentry else None, sentry_send_pii=args.send_pii)
