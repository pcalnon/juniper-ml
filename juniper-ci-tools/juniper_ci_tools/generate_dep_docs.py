...
def generate_dep_docs(
    *,
    ...
    conf_dir: str = "conf",
    notes_dir: str = "notes",
    pip_header_name: str = "JUNIPER_2026-03-11_JUNIPER-ML_PIP-DEPENDENCY-FILE-HEADER.md",
    conda_header_name: str = "JUNIPER_2026-03-15_JUNIPER-ML_CONDA-DEPENDENCY-FILE-HEADER.md",
