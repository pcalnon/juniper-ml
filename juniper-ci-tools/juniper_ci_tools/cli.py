...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--pip-header", default="JUNIPER_2026-03-11_JUNIPER-ML_PIP-DEPENDENCY-FILE-HEADER.md", help="Pip-requirements header template filename (in --notes-dir).")
    parser.add_argument("--conda-header", default="JUNIPER_2026-03-15_JUNIPER-ML_CONDA-DEPENDENCY-FILE-HEADER.md", help="Conda-environment header template filename (in --notes-dir).")
