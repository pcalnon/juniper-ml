...
└── util/                      # Utility scripts and tools
    ...
    ├── scaffold_template.py              # Custom-agent suite (P5): generate a new prompts/templates/ template + manifest stanza
