...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host/isolated/experiment stacks, F-CANOPY-027 starvation probes, Duplicati, fleet triage / sequence-safety, shared-package CI + publish, flood CI gates |
