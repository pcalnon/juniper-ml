...
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host/isolated/experiment-stack ops (incl. suite-report gate inputs), CI/publish, flood gates, service-core |
| **DEVELOPER_CHEATSHEET_JUNIPER-ML.md** | Cheatsheet | Quick-reference card for common development, host-stack, CI guardrail and hygiene tasks, signing-ceremony tasks, service-core contracts, experiment-stack tasks, and suite-report gate inputs |
| **REFERENCE.md**                       | Reference  | Extras, compatibility, host-stack / isolated-stack / experiment-stack ops (incl. suite-report gate inputs), Duplicati backup, agent-suite doctor, post-merge main-verify, YubiKey GPG, fleet triage / sequence-safety, shared-package CI + publish, security-scan / lockfile, docs-full-check, release-train detect, AGENTS.md date check, `claude.yml` access, sibling packages (incl. service-core), flood CI gates, and open-PR budget alarm |
...
| **JUNIPER_2026-09-02_JUNIPER-ECOSYSTEM_PERF-LANE-P2-PLAN.md** | Plan   | Perf-lane Wave 1 items; item 1.4 operator surface in [REFERENCE — Suite Report Gate Inputs](REFERENCE.md#suite-report-gate-inputs) |
