...
| **Census X7 off-loop / slice 1a** | [REFERENCE — X7 Off-Loop Census](REFERENCE.md#x7-off-loop-census) (shipped count is 58; canopy gate + callgraph are authority; C5 remedy refuted) | docs/    |
...
| **JUNIPER_2026-09-03_JUNIPER-CANOPY_X7-EVENT-LOOP-BLOCKING-REMEDIATION-DESIGN.md**              | Design      | X7 event-loop blocking; §5.2 count of 36/52 superseded by **58**; operator surface in [REFERENCE](REFERENCE.md#x7-off-loop-census) |
