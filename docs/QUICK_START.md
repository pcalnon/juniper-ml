...
- [Pointer-Follow Soak](REFERENCE.md#pointer-follow-soak) -- unprimed probe loop, characterisation vs least-covered, `--dry-run` exempt from the terminal-verdict stop (#1690)
