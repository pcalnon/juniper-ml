...
- [Canopy E2E Topology Driver](REFERENCE.md#canopy-e2e-topology-driver) -- Playwright scorer for Topology-tab rows; after #1672 M-06/M-07 are AND predicates and M-12 scores Clear
